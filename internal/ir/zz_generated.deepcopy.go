...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPFilterExtensionRefs) DeepCopyInto(out *HTTPFilterExtensionRefs) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPFilterExtensionRefs.
func (in *HTTPFilterExtensionRefs) DeepCopy() *HTTPFilterExtensionRefs {
	if in == nil {
		return nil
	}
	out := new(HTTPFilterExtensionRefs)
	in.DeepCopyInto(out)
	return out
}
